...
export class State {
  ...
  gallerySpace: chain.object_space;
  ...
  constructor(contractId: Uint8Array) {
    ...
    this.gallerySpace = new chain.object_space(false, contractId, GALLERY_SPACE_ID);
  ...
  // gallery
  getGallery(owner: Uint8Array): collections.gallery_object {
    const gallery = System.getObject<Uint8Array, collections.gallery_object>(this.gallerySpace, owner, collections.gallery_object.decode);
    if (gallery) {
      return gallery;
    }
    return new collections.gallery_object();
  }
  saveGallery(owner: Uint8Array, gallery: collections.gallery_object): void {
    System.putObject(this.gallerySpace, owner, gallery, collections.gallery_object.encode);
  }
